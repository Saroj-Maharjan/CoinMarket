package com.sawrose.cryptotracker.crypto.presentation.coin_detail
...
import com.sawrose.cryptotracker.crypto.presentation.coin_detail.component.InfoCard
import com.sawrose.cryptotracker.crypto.presentation.coin_list.CoinListState
import com.sawrose.cryptotracker.crypto.presentation.coin_list.components.previewCoin
import com.sawrose.cryptotracker.crypto.presentation.model.toDisplayableNumber
        ...
        Column(
            ...
            FlowRow(
                ...
                val absoluteChangeFormatted =
                    (coin.priceUsd.value * (coin.changePercent24Hr.value / 100f))
                        .toDisplayableNumber()
